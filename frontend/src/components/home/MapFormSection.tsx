...
export function MapFormSection({ showHeading = true }: { showHeading?: boolean }) {
  return (
    <section className="mx-auto max-w-[1280px] px-4 py-12 md:px-6 md:py-24">
      ...
      <div className={`grid gap-8 lg:grid-cols-2 lg:gap-12 ${showHeading ? 'mt-10' : ''}`}>
        <div className="overflow-hidden rounded-[24px] border border-border-light bg-surface shadow-[0_12px_24px_-8px_rgba(0,0,0,0.08)]">
          <iframe
