      ...
      >
        ...
        >
          ...
          {subtitle.trim() && (ctaSecondary.trim() || ctaPrimary.trim()) ? (
            <motion.div
              className="mt-auto flex w-full flex-row items-center gap-3 pt-20 sm:gap-4 sm:pt-24 lg:hidden"
              initial={from}
              animate={to}
            ...
            <motion.p
              className={`fabric-body mt-auto pt-20 font-body text-[10px] font-normal uppercase leading-snug tracking-[0.1em] sm:pt-24 lg:hidden ${textClasses.body}`}
              initial={from}
              animate={to}
              transition={{ ...easeOutSoft, delay: 0.22 }}
            >
