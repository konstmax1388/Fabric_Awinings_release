...
/** Слаг категории с бэкенда; в URL листинга: /catalog/category/:slug (параметр ?category= — редирект на path). */
...
export const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description:
      'Ремонт и изготовление сдвижных тентов для тентованных фур. Подбор цвета и плотности ПВХ, замена направляющих по согласованию. Всё в наличии.',
    category: 'truck',
    images: [
