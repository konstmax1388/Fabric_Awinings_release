"""Sitemap и robots.txt (учёт настроек индексации в SiteSettings)."""
...
from .models import BlogPost, Product, SiteSettings
...
def sitemap_xml_view(request):
    if not SiteSettings.get_solo().seo_allow_indexing:
        body = (
...
def robots_txt_view(request):
    ...
    if not site.seo_allow_indexing:
        body = "User-agent: *\nDisallow: /\n"
    else:
