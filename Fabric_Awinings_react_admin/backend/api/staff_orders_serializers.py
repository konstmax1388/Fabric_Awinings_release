...
class CartOrderStaffSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance: CartOrder) -> dict[str, Any]:
        """Без super(): ChoiceField/JSONField на «битых» данных из БД давали 500 на списке заказов."""
        lines = instance.lines if isinstance(instance.lines, list) else []
        snap = instance.delivery_snapshot if isinstance(instance.delivery_snapshot, dict) else {}
        acq = instance.acquiring_payload if isinstance(instance.acquiring_payload, dict) else {}
        uid = instance.user_id
        return {
            "id": str(instance.pk),
            "orderRef": instance.order_ref,
            "customerName": instance.customer_name,
            "customerPhone": instance.customer_phone,
            "customerEmail": instance.customer_email or "",
            "customerComment": instance.customer_comment or "",
            "userId": str(uid) if uid else None,
            "lines": lines,
            "totalApprox": instance.total_approx,
            "managerLetter": instance.manager_letter or "",
            "clientAck": instance.client_ack or "",
            "createdAt": instance.created_at.isoformat() if instance.created_at else None,
            "fulfillmentStatus": instance.fulfillment_status,
            "paymentStatus": instance.payment_status,
            "paymentProvider": instance.payment_provider or "",
            "paymentExternalId": instance.payment_external_id or "",
            "deliveryMethod": instance.delivery_method,
            "paymentMethod": instance.payment_method,
            "deliveryProvider": instance.delivery_provider or "",
            "deliverySnapshot": snap,
            "cdekTracking": instance.cdek_tracking or "",
            "acquiringPayload": acq,
            "bitrixEntityId": instance.bitrix_entity_id or "",
            "bitrixSyncStatus": instance.bitrix_sync_status,
            "bitrixSyncError": instance.bitrix_sync_error or "",
            "bitrixSyncAttempts": instance.bitrix_sync_attempts,
        }
